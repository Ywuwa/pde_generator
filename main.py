...
if __name__ == "__main__":
    ...
    constants, equations, implicit_eq = parse_input_file("fda2.txt")
    print(equations)
    print(implicit_eq)
    generated_cpp, generated_hpp, compute_flow_cpp_code = generate_src_n_header(
      constants, equations, implicit_eq)
